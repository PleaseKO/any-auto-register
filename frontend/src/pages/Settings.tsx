    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          { key: 'luckmail_poll_interval_seconds', label: '轮询间隔秒数', placeholder: '5' },
        ],
      },
    ],
  },
...
export default function Settings() {
  ...
  useEffect(() => {
    apiFetch('/config').then((data) => {
      ...
      if (!data.luckmail_poll_interval_seconds) {
        data.luckmail_poll_interval_seconds = '5'
      }
